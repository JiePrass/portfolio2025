...
export default function About() {
    return (
        <section id="about" className="container mx-auto px-6 py-12 lg:py-20 flex justify-center flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex justify-center">
                ...
                <div className="relative">
                    ...
                    {/* Certified Badge */}
                    <div className="absolute bottom-4 left-1/2 whitespace-nowrap bg-card-muted dark:bg-dark-card px-6 py-2 rounded-full shadow flex items-center gap-2">
